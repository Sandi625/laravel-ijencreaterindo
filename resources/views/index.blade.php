        ...
        <section class="place section" id="place">
            ...
            <div class="place__container container grid">
                ...
                <div class="place__card">
                    <a href="{{ route('bali.page') }}" class="place__link">
                        <img src="{{ asset('assets/img/bali2.jpg') }}" alt="Bali" class="place__img">
                ...
                <!--==================== PLACES CARD 2 ====================-->
                <div class="place__card">
                    <a href="{{ route('bromo.page') }}" class="place__link">
                        <img src="{{ asset('assets/img/bromo.jpg') }}" alt="Bromo" class="place__img">
                        <div class="place__content">
                            <span class="place__rating">
                                <i class="ri-star-line place__rating-icon"></i>
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__subtitle">MOUNT BROMO-IJEN-TUMPAK SEWU, BLUE FIRE 3 Day 2 Nights</span>
                                <span class="place__price">Klik for more</span>
                            </div>
                        </div>
                        <button class="button button--flex place__button">
                ...
                <!--==================== PLACES CARD 3 ====================-->
                <div class="place__card">
                    <a href="{{ route('djawatan-pulaumerah.page') }}" class="place__link">
                        <img src="{{ asset('assets/img/djawatan3.jpg') }}" alt="Djawatan Pulaumerah" class="place__img">
                        <div class="place__content">
                            <span class="place__rating">
                                <i class="ri-star-line place__rating-icon"></i>
                ...
                <!--==================== PLACES CARD 4 ====================-->
                <div class="place__card">
                    <a href="{{ route('baluran-tabuhan.page') }}" class="place__link">
                        <img src="{{ asset('assets/img/baluran2.jpg') }}" alt="Baluran Tabuhan" class="place__img">
                        <div class="place__content">
                            <span class="place__rating">
                                <i class="ri-star-line place__rating-icon"></i>
                                <span class="place__rating-number">4,9</span>
                    ...
                    <a href="{{ route('village.page') }}" class="place__link">
                        ...
                        <div class="place__content">
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__subtitle">Explore Village in Banyuwangi, Licin</span>
                                <span class="place__price">Klik for more</span>
                            </div>
                        </div>
                        <button class="button button--flex place__button">
